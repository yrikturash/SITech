...
namespace SITech.Controllers
{
    public class PaymentController : BaseController
    {
        ...
        public ActionResult PaymentWithCreditCard()
        {
            ...
            billingAddress.country_code = "UA";
            billingAddress.line1 = "5th street lukash";
            billingAddress.postal_code = "79012";
            billingAddress.state = "UA";
            ...
            crdtCard.cvv2 = "234";  //card cvv2 number
            crdtCard.expire_month = 12; //card expire date
            crdtCard.expire_year = 2018; //card expire year
            crdtCard.first_name = "Mopp";
            crdtCard.last_name = "Nerr";
            crdtCard.number = "4149496621423358"; //enter your credit card number here
